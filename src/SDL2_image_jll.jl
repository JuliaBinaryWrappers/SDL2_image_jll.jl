...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SDL2_image_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("41f3cfe1-fd11-58ad-8074-b9730c29438b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SDL2_image", artifacts_toml) for e in artifacts["SDL2_image"]]
...
if best_platform === nothing
    @debug("Unable to load SDL2_image; unsupported platform $(triplet(platform_key_abi()))")
else
