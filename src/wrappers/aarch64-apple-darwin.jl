# Autogenerated wrapper script for SDL2_image_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(libsdl2_image, "@rpath/libSDL2_image-2.0.3.0.0.dylib")
function __init__()
